            ...
            children: [
              ...
              LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  double totalBarsWidth = (filteredTeamsList.length *
                          (barWidth * 2 + barSpace + 20))
                                  ...
                                  builder: (context, child) {
                                    return BarChart(
                                      BarChartData(
                                        ...
                                        maxY: getMaxYValue(),
                                        barGroups:
                                            filteredTeamsList.asMap().entries.map((entry) {
                                          int index = entry.key;
                                          Team team = entry.value;
                                          Color teamColor = getTeamColor(team.name);
                                          double animatedWins =
                                              team.yearWins.toDouble() * _animationController.value;
                                          double animatedPodiums =
                                              team.yearPodiums.toDouble() * _animationController.value;
                                        ...
                                        barTouchData: BarTouchData(
                                          ...
                                          touchTooltipData: BarTouchTooltipData(
                                            getTooltipItem:
                                              ...
                                              String title = rodIndex == 0 ? 'Wins' : 'Podiums';
